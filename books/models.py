...
class Publication(models.Model):
    ...
    publication_date = models.DateField(null=True, blank=True, validators=[validate_publication_date])
    ...
    page_count = models.PositiveIntegerField(null=True, blank=True, validators=[MaxValueValidator(50000)])
    book_cover = models.URLField(max_length=500, null=True, blank=True)
    language = models.CharField(max_length=10, null=True, blank=True)  # Short code ISO-639-1
